...
/**
 *	Query for user input demanding Determinant Operation
 *	@author Avraham Katz
 *	@version 1.1
 */

public class DeterminantQuery implements CalculatorQuery
{
    private Matrix matrix;


    public DeterminantQuery(String variable)
    {
        this.matrix = InternalStorage.Singleton.get(variable);
    }


    public DeterminantQuery()
    {
    ...
    public void runOperation()
    {
        try
        {
            BigDecimal finalBigDecimal = this.matrix.determinant();
