...
/**
 *	Query for user input demanding Matrix Subtraction Operation
 *	@author Avraham Katz
 *	@version 1.1
 */

public class MatrixSubstractionQuery implements CalculatorQuery
{
    private Matrix matrix1;
    private Matrix matrix2;


    public MatrixSubstractionQuery(String variable1, String variable2)
    {
    ...
    public MatrixSubstractionQuery(String variable2)
    {
    ...
    public void runOperation()
    {
        try
        {
            Matrix finalMatrix = this.matrix1.subtract(this.matrix2);
        ...
        {
            System.out.printf("<ERROR: cannot perform matrix subtraction on matrices of different sizes... %s != %s> %n%n", this.matrix1.getSize(), this.matrix2.getSize());
        }
    }
}
